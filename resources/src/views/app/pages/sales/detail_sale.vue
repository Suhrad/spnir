        ...
        <div class="invoice-print">
          ...
          <b-row class="mt-5">
            <b-col lg="4" md="4" sm="12" class="mb-4">
              ...
              <div v-if="sale.client_gstin">GSTIN: {{sale.client_gstin}}</div>
              <div v-if="sale.client_pan">PAN: {{sale.client_pan}}</div>
              <div v-if="sale.client_place_of_supply">Place of Supply: {{sale.client_place_of_supply}}</div>
            </b-col>
            <b-col lg="4" md="4" sm="12" class="mb-4">
            ...
            <b-col lg="4" md="4" sm="12" class="mb-4">
              ...
              <div v-if="sale.transporter_name">Transporter: {{sale.transporter_name}}</div>
              <div v-if="sale.transporter_gstin">Transporter GSTIN: {{sale.transporter_gstin}}</div>
              <div v-if="sale.vehicle_number">Vehicle No: {{sale.vehicle_number}}</div>
              <div v-if="sale.lr_number">LR No: {{sale.lr_number}}</div>
