        ...
        <b-row>
          ...
          <b-col md="12">
            <b-form-group label="Company">
              <b-form-select v-model="Filter_BusinessCompany" :options="companyOptions"></b-form-select>
            </b-form-group>
          </b-col>
        ...
        <b-form @submit.prevent="Submit_Customer">
          <b-row>
            ...
            <b-col md="6" sm="12">
                <b-form-group label="Company">
                  <b-form-select
                    v-model="client.business_company_id"
            ...
            <b-col md="6" sm="12">
                <b-form-group label="State">
                  <b-form-input v-model="client.state" placeholder="State"></b-form-input>
                </b-form-group>
            </b-col>

            <b-col md="6" sm="12">
                <b-form-group label="PIN Code">
                  <b-form-input v-model="client.pin_code" placeholder="PIN code"></b-form-input>
                </b-form-group>
            </b-col>

            <b-col md="6" sm="12">
                <b-form-group label="GSTIN">
                  <b-form-input v-model="client.gstin" placeholder="GSTIN"></b-form-input>
                </b-form-group>
            </b-col>

            <b-col md="6" sm="12">
                <b-form-group label="PAN">
                  <b-form-input v-model="client.pan" placeholder="PAN"></b-form-input>
                </b-form-group>
            </b-col>

            <b-col md="6" sm="12">
                <b-form-group label="Place of Supply">
                  <b-form-input v-model="client.place_of_supply" placeholder="Place of supply"></b-form-input>
                </b-form-group>
            </b-col>

            <b-col md="6" sm="12">
                <b-form-group label="GST Type">
                  <b-form-input v-model="client.gst_type" placeholder="GST type"></b-form-input>
                </b-form-group>
            </b-col>

            <b-col md="6" sm="12">
                <b-form-group label="Contact Person">
                  <b-form-input v-model="client.contact_person" placeholder="Contact person"></b-form-input>
                </b-form-group>
            </b-col>
          ...
          <table class="table table-striped table-md">
            <tbody>
              ...
              <tr>
                ...
                <th>{{client.address_line_1}}</th>
              </tr>
              <tr>
                <td>Address Line 2</td>
                <th>{{client.address_line_2}}</th>
              </tr>
              <tr>
                <td>Address Line 3</td>
                <th>{{client.address_line_3}}</th>
              </tr>
              <tr>
                <td>State</td>
                <th>{{client.state}}</th>
              ...
              <tr>
                ...
                <th>{{client.place_of_supply}}</th>
              </tr>
              <tr>
                <td>GST Type</td>
                <th>{{client.gst_type}}</th>
              </tr>
              <tr>
                <td>Contact Person</td>
                <th>{{client.contact_person}}</th>
              </tr>
...
export default {
  ...
  computed: {
    ...
    companyOptions() {
      return [{ value: "", text: "All Companies" }].concat(
    ...
    Get_Clients(page) {
      ...
      axios
        ...
        .then(response => {
          ...
          this.business_companies = response.data.business_companies || [];
