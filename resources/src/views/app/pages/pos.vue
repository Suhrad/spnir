      ...
      <b-row v-if="!isLoading">
        ...
        <b-col md="5">
          <b-card no-body class="card-order">
            <div class="main-header" style=" height: 50px; ">
              <div class="logo">
                <router-link to="/app/dashboard">
                  <img :src="'/images/'+currentUser.logo" alt width="40" height="40" style=" width: 40px; height: 40px; ">
                </router-link>
              </div>
                  ...
                  <div class="footer_panel">
                    <b-row>
                     ...
                     <b-col lg="6" md="6" sm="12" v-if="clientIsEligible && currentUserPermissions && currentUserPermissions.includes('edit_tax_discount_shipping_sale')">
                      <b-form-group :label="$t('Available_Points')">
                        <b-input-group>
                          <b-form-input
        ...
        <b-col md="7">
          ...
          >
            <b-button
              ...
              @click="Reset_Pos()"
              variant="danger ripple btn-rounded"
            >
            ...
            <b-button
              style="min-width: 120px;"
              @click="Submit_Pos()"
              variant="success ripple btn-rounded"
            >
              <i class="i-Checkout"></i> {{ $t("payNow") }}
            </b-button>
            ...
            <b-button
              ...
              variant="primary ripple btn-rounded"
            >
              <i class="i-Sand-watch"></i> {{ $t("Draft") }}
            </b-button>

            <b-button
              style="min-width: 140px;"
              @click="Show_Draft_Sales()"
              variant="light ripple btn-rounded"
            >
              <i class="i-Alarm-Clock"></i> {{ $t("Recent_Drafts") }}
            </b-button>
          </div>
              ...
              <b-row>
                ...
                <b-col md="12" sm="12">
                 ...
                 <b-col md="6" sm="12" class="mt-4 mb-4">
                  <label class="checkbox checkbox-primary mb-3"><input type="checkbox" v-model="client.is_royalty_eligible"><h5>is royalty eligible </h5><span class="checkmark"></span></label>
                </b-col>
