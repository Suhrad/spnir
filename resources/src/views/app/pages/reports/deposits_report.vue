      ...
      <b-card class="wrapper" v-if="!isLoading">
        ...
        >
         ...
         <div slot="table-actions" class="mt-2 mb-3">
          ...
          <b-button @click="deposits_report_pdf()" size="sm" variant="outline-success ripple m-1" :disabled="exporting_pdf">
  ...
  export default {
    ...
    methods: {
      ...
      export_Excel() {
        ...
        NProgress.start();
        NProgress.set(0.1);
        this.fetch_all_deposits().then(response => {
          let all_deposits = response.data.reports;

          // Calculate totals based on the complete list
          let totalGrandTotal = all_deposits.reduce((sum, report) => sum + parseFloat(report.total_deposits || 0), 0);
          ...
          this.excel_deposits = all_deposits;
          this.$nextTick(() => {
      ...
      deposits_report_pdf() {
        ...
        NProgress.start();
        self.fetch_all_deposits().then(response => {
          let all_deposits = response.data.reports;
