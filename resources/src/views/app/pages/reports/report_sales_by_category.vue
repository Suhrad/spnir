  ...
  export default {
    ...
    sumCount(rowObj) {
      return this.sumAmount(rowObj);
       ...
       //----------------------------------- Sales PDF ------------------------------\\
      fetch_all_sales_by_category() {
        this.get_data_loaded();
        return axios.get(
          "report/sales_by_category_report?page=1" +
            "&SortField=" +
      ...
      export_Excel() {
        ...
        NProgress.start();
        NProgress.set(0.1);
        this.fetch_all_sales_by_category().then(response => {
      ...
      report_pdf() {
        ...
        NProgress.start();
        self.fetch_all_sales_by_category().then(response => {
          let all_sales = response.data.reports;
