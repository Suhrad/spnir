...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    Calcul_Total: function Calcul_Total() {
      ...
      this.GrandTotal = parseFloat(total_without_discount + this.sale.TaxNet + this.sale.shipping + (parseFloat(this.sale.manual_gst_amount) || 0) + (parseFloat(this.sale.packaging_forwarding_charge) || 0));
