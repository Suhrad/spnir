...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    Calcul_Total: function Calcul_Total() {
      ...
      var exact_total = total_without_discount + this.sale.TaxNet + this.sale.shipping + this.sale.manual_gst_amount + (parseFloat(this.sale.packaging_forwarding_charge) || 0);
    ...
    Calcul_Gst_Percent: function Calcul_Gst_Percent() {
      ...
      var total_without_discount = parseFloat(this.total - this.sale.discount) || 0;
