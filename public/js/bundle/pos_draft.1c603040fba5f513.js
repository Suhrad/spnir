...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_5__.mapGetters)(["currentUser", "currentUserPermissions"])), {}, {
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_5__.mapActions)(["changeSidebarProperties", "changeThemeMode", "logout"])), {}, (_objectSpread2 = {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              _context.n = 1;
              return axios.get("/retrieve-customer?customerId=".concat(_this2.selectedClientId)).then(function (response) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              _context2.n = 1;
              return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_4__.loadStripe)("".concat(_this4.stripe_key));
            case 1:
    ...
    this.$refs.create_pos.validate().then(function (success) {
      if (!success) {
        ...
        if (_this5.selectedClientId == "" || _this5.selectedClientId === null) {
      ...
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.p = _context3.n) {
          case 0:
            ...
            _this1.discount_from_points = 0;
            _this1.used_points = 0;
            _this1.clientIsEligible = false;
            _this1.pointsConverted = false; // 👈 Reset conversion state
            _this1.sale.discount = 0; // 👈 Reset applied discount
            client = _this1.clients.find(function (c) {
            ...
            _this1.client_name = client.name;
            _this1.selectedClientId = selectedClientId;
            _context3.p = 1;
            _context3.n = 2;
          ...
          case 2:
            ...
            if (data.is_royalty_eligible) {
              _this1.selectedClientPoints = data.points;
              _this1.clientIsEligible = true;
            } else {
              _this1.selectedClientPoints = 0;
              _this1.clientIsEligible = false;
            }
    ...
    axios.get("get_Products_by_warehouse/" + id + "?stock=" + 1 + "&is_sale=" + 1 + "&product_service=" + 1).then(function (response) {
      _this10.products_pos = response.data;
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
    })["catch"](function (error) {});
    ...
    setTimeout(function () {
      _this13.$bvModal.show("form_Update_Detail");
    }, 1000);
    ...
    this.CalculTotal();
    setTimeout(function () {
      _this14.$bvModal.hide("form_Update_Detail");
    }, 1000);
  ...
  }), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_objectSpread2, "print_pos", function print_pos() {
    ...
    axios.get("sales_print_invoice/" + id).then(function (response) {
      ...
      _this15.payments = response.data.payments;
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
      ...
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.n) {
          ...
          case 1:
            _yield$_this16$stripe = _context4.v;
            ...
            if (error) {
              ...
              axios.post("pos/submit_sale_from_draft", {
                draft_sale_id: _this16.draft_sale_id,
                client_id: _this16.selectedClientId,
                warehouse_id: _this16.sale.warehouse_id,
                tax_rate: _this16.sale.tax_rate ? _this16.sale.tax_rate : 0,
                TaxNet: _this16.sale.TaxNet ? _this16.sale.TaxNet : 0,
                discount: _this16.sale.discount ? _this16.sale.discount : 0,
                shipping: _this16.sale.shipping ? _this16.sale.shipping : 0,
                details: _this16.details,
                GrandTotal: _this16.GrandTotal,
                payment: _this16.payment,
                account_id: _this16.payment.account_id,
                amount: parseFloat(_this16.payment.amount).toFixed(2),
                received_amount: parseFloat(_this16.payment.received_amount).toFixed(2),
                change: parseFloat(_this16.payment.received_amount - _this16.payment.amount).toFixed(2),
                token: token.id,
                is_new_credit_card: _this16.is_new_credit_card,
                selectedCard: _this16.selectedCard,
                card_id: _this16.card_id,
                discount_from_points: _this16.discount_from_points,
                used_points: _this16.used_points
              }).then(function (response) {
                _this16.paymentProcessing = false;
    ...
    axios.get("/show_product_data/" + product_id + "/" + variant_id).then(function (response) {
      _this18.product.discount = response.data.discount;
      _this18.product.DiscountNet = response.data.DiscountNet;
      _this18.product.discount_Method = response.data.discount_method;
      _this18.product.product_id = response.data.id;
      _this18.product.product_type = response.data.product_type;
      ...
      _this18.product.product_variant_id = variant_id;
      _this18.product.code = response.data.code;
      _this18.product.fix_price = response.data.fix_price;
      _this18.product.sale_unit_id = response.data.sale_unit_id;
      _this18.product.is_imei = response.data.is_imei;
      _this18.product.imei_number = '';
      _this18.add_product(response.data.code);
      _this18.CalculTotal();
      // Complete the animation of theprogress bar.
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
    });
    ...
    this.CalculTotal();
    this.$forceUpdate();
  }), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_objectSpread2, "decrement", function decrement(detail, id) {
    for (var i = 0; i < this.details.length; i++) {
      if (this.details[i].detail_id == id) {
      ...
      return _regenerator().w(function (_context5) {
        while (1) switch (_context5.p = _context5.n) {
          case 0:
            ...
            _this20.pointsConverted = false; // 👈 Reset conversion state
  ...
  }), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_objectSpread2, "search", function search() {
    var _this21 = this;
    if (this.timer) {
    ...
    if (this.sale.warehouse_id != "" && this.sale.warehouse_id != null) {
      this.timer = setTimeout(function () {
        ...
        if (barcode.length === 13 && !isNaN(barcode)) {
          ...
          _this21.$refs.product_autocomplete.value = "";
    ...
    axios.get("pos/data_draft_convert_sale/".concat(id)).then(function (response) {
      ...
      _this23.payment_methods = response.data.payment_methods;
      ...
      _this23.selectedClientId = response.data.client_id;
      _this23.clientIsEligible = response.data.default_client_eligible === true || response.data.default_client_eligible === 1;
      _this23.selectedClientPoints = _this23.clientIsEligible ? parseFloat(response.data.default_client_points) : 0;
      _this23.point_to_amount_rate = response.data.point_to_amount_rate;
      _this23.getProducts();
  ...
  created: function created() {
    ...
    Fire.$on("pay_now", function () {
      setTimeout(function () {
        ...
        _this24.payment.payment_method_id = 2;
