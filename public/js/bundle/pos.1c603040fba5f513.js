...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_5__.mapGetters)(["currentUser", "currentUserPermissions", "show_language"])), {}, {
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_5__.mapActions)(["changeSidebarProperties", "changeThemeMode", "logout"])), {}, (_objectSpread2 = {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              _context.n = 1;
              return axios.get("/retrieve-customer?customerId=".concat(_this4.selectedClientId)).then(function (response) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              _context2.n = 1;
              return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_4__.loadStripe)("".concat(_this6.stripe_key));
            case 1:
    ...
    this.$refs.create_pos.validate().then(function (success) {
      if (!success) {
        ...
        if (_this7.selectedClientId == "" || _this7.selectedClientId === null) {
    ...
    this.$refs.create_pos.validate().then(function (success) {
      if (!success) {
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
        if (_this8.selectedClientId == "" || _this8.selectedClientId === null) {
    ...
    axios.post("clients", {
      ...
      // Extract the newly created client from response
      var newClient = response.data;

      // Add the new client to the clients list
      _this14.clients.push({
        id: newClient.id,
        name: newClient.name
      });

      // Automatically select the new client
      _this14.selectedClientId = newClient.id;
      _this14.client_name = newClient.name;
      _this14.onClientSelected(newClient.id);
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
      ...
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.p = _context3.n) {
          case 0:
            _this16.client_name = '';
            _this16.selectedClientPoints = 0;
            _this16.discount_from_points = 0;
            _this16.used_points = 0;
            _this16.clientIsEligible = false;
            _this16.pointsConverted = false; // 👈 Reset conversion state
            _this16.sale.discount = 0; // 👈 Reset applied discount
            client = _this16.clients.find(function (c) {
            ...
            _this16.client_name = client.name;
            _this16.selectedClientId = selectedClientId;
            _context3.p = 1;
            _context3.n = 2;
          ...
          case 2:
            ...
            if (data.is_royalty_eligible) {
              _this16.selectedClientPoints = data.points;
              _this16.clientIsEligible = true;
            } else {
              _this16.selectedClientPoints = 0;
              _this16.clientIsEligible = false;
            }
    ...
    axios.get("get_today_sales").then(function (response) {
      _this17.today_sales = response.data;
      setTimeout(function () {
        _this17.$bvModal.show("modal_today_sales");
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
      }, 1000);
    })["catch"](function (error) {});
    ...
    axios.get("get_Products_by_warehouse/" + id + "?stock=" + 1 + "&is_sale=" + 1 + "&product_service=" + 1 + "&product_combo=" + 1).then(function (response) {
      _this18.products_pos = response.data;
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
    })["catch"](function (error) {});
    ...
    setTimeout(function () {
      _this21.$bvModal.show("form_Update_Detail");
    }, 1000);
    ...
    this.CalculTotal();
    setTimeout(function () {
      _this22.$bvModal.hide("form_Update_Detail");
    }, 1000);
    ...
    axios.get("sales_print_invoice/" + id).then(function (response) {
      _this23.invoice_pos = response.data;
      _this23.payments = response.data.payments;
      _this23.pos_settings = response.data.pos_settings;
      setTimeout(function () {
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
      var _yield$_this24$stripe, token, error;
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.n) {
          case 0:
            _this24.paymentProcessing = true;
            _context4.n = 1;
            return _this24.stripe.createToken(_this24.cardElement);
          case 1:
            _yield$_this24$stripe = _context4.v;
            token = _yield$_this24$stripe.token;
            error = _yield$_this24$stripe.error;
            if (error) {
              ...
              axios.post("pos/create_pos", {
                client_id: _this24.selectedClientId,
                warehouse_id: _this24.sale.warehouse_id,
                tax_rate: _this24.sale.tax_rate ? _this24.sale.tax_rate : 0,
                TaxNet: _this24.sale.TaxNet ? _this24.sale.TaxNet : 0,
                discount: _this24.sale.discount ? _this24.sale.discount : 0,
                shipping: _this24.sale.shipping ? _this24.sale.shipping : 0,
                details: _this24.details,
                GrandTotal: _this24.GrandTotal,
                notes: _this24.sale.notes,
                // ✅ NEW: Multi-payment array
                payments: _this24.paymentLines,
                send_email: _this24.sendEmail,
                send_sms: _this24.sendSMS,
                // Optional global account_id (used once for all)
                account_id: _this24.selectedAccount,
                payment_note: _this24.globalPaymentNote || '',
                token: token.id,
                is_new_credit_card: _this24.is_new_credit_card,
                selectedCard: _this24.selectedCard,
                card_id: _this24.card_id,
                discount_from_points: _this24.discount_from_points,
                used_points: _this24.used_points
              }).then(function (response) {
                _this24.paymentProcessing = false;
                if (response.data.success === true) {
                  // Complete the animation of theprogress bar.
    ...
    var anyNewCard = this.paymentLines.some(function (p) {
      return (p.payment_method_id === '1' || p.payment_method_id === 1) && _this25.is_new_credit_card;
    });
    if (anyNewCard) {
      if (this.stripe_key !== '') {
    ...
    axios.get("/show_product_data/" + product_id + "/" + variant_id).then(function (response) {
      _this26.product.discount = response.data.discount;
      _this26.product.DiscountNet = response.data.DiscountNet;
      _this26.product.discount_Method = response.data.discount_method;
      _this26.product.product_id = response.data.id;
      _this26.product.product_type = response.data.product_type;
      _this26.product.name = response.data.name;
      _this26.product.Net_price = response.data.Net_price;
      _this26.product.Total_price = response.data.Total_price;
      _this26.product.Unit_price = response.data.Unit_price;
      _this26.product.taxe = response.data.tax_price;
      _this26.product.tax_method = response.data.tax_method;
      _this26.product.tax_percent = response.data.tax_percent;
      _this26.product.unitSale = response.data.unitSale;
      _this26.product.product_variant_id = variant_id;
      _this26.product.code = response.data.code;
      _this26.product.fix_price = response.data.fix_price;
      _this26.product.sale_unit_id = response.data.sale_unit_id;
      _this26.product.is_imei = response.data.is_imei;
      _this26.product.imei_number = '';
      _this26.add_product(response.data.code);
      _this26.CalculTotal();
      // Complete the animation of theprogress bar.
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
    });
      ...
      return _regenerator().w(function (_context5) {
        while (1) switch (_context5.p = _context5.n) {
          case 0:
            ...
            _this28.paymentLines = [{
              amount: 0,
              payment_method_id: '2'
            }];
            _this28.selectedAccount = null;
            _this28.globalPaymentNote = '';
            _this28.savedPaymentMethods = [], _this28.hasSavedPaymentMethod = false, _this28.useSavedPaymentMethod = false, _this28.selectedCard = null, _this28.card_id = '', _this28.is_new_credit_card = false, _this28.submit_showing_credit_card = false, _this28.sale.tax_rate = 0;
            _this28.sale.TaxNet = 0;
            _this28.sale.shipping = 0;
            _this28.sale.discount = 0;
            _this28.sale.notes = '';
            _this28.GrandTotal = 0;
            _this28.total = 0;
            _this28.category_id = "";
            _this28.brand_id = "";
            _this28.selectedClientPoints = 0;
            _this28.used_points = 0;
            _this28.discount_from_points = 0;
            _this28.clientIsEligible = false;
            _this28.pointsConverted = false; // 👈 Reset conversion state
            client = _this28.clients.find(function (client) {
              return client.id === 1;
            });
            if (!client) {
              _context5.n = 4;
            ...
            _this28.client_name = client.name;
            _this28.selectedClientId = 1;
            _context5.p = 1;
            _context5.n = 2;
            return axios.get("/get_points_client/".concat(_this28.selectedClientId));
          case 2:
            response = _context5.v;
            data = response.data;
            if (data.is_royalty_eligible) {
              _this28.selectedClientPoints = data.points;
              _this28.clientIsEligible = true;
            } else {
              _this28.selectedClientPoints = 0;
              _this28.clientIsEligible = false;
            }
    ...
    if (this.sale.warehouse_id != "" && this.sale.warehouse_id != null) {
      this.timer = setTimeout(function () {
        var barcode = _this29.search_input.trim();
        var weight = null;
        ...
        if (barcode.length === 13 && !isNaN(barcode)) {
          ...
          var product = _this29.products_pos.find(function (prod) {
            return prod.code === barcode;
          });
          if (product) {
            _this29.Check_Product_Exist(product, product.id, weight);
            return;
          } else {
            ...
            var _product = _this29.products_pos.find(function (prod) {
              return prod.code === productCode;
            });
            if (_product) {
              _product.quantity = _weight; // Assign weight to product
              _this29.Check_Product_Exist(_product, _product.id, _weight);
              return;
            }
          }
          _this29.makeToast("danger", "Invalid product code scanned", _this29.$t("Error"));
          _this29.search_input = '';
          _this29.$refs.product_autocomplete.value = "";
          _this29.product_filter = [];
        }
        // else{
        ...
        if (product_filter.length === 1) {
          _this29.Check_Product_Exist(product_filter[0], product_filter[0].id, weight = null);
        } else {
    ...
    axios.get("pos/data_create_pos").then(function (response) {
      ...
      _this31.payment_methods = response.data.payment_methods;
      _this31.sale.warehouse_id = response.data.defaultWarehouse;
      _this31.selectedClientId = response.data.defaultClient;
      _this31.client_name = response.data.default_client_name;
      _this31.clientIsEligible = response.data.default_client_eligible === true || response.data.default_client_eligible === 1;
      _this31.selectedClientPoints = _this31.clientIsEligible ? parseFloat(response.data.default_client_points) : 0;
      _this31.point_to_amount_rate = response.data.point_to_amount_rate;
      _this31.product_perPage = response.data.products_per_page;
      _this31.languages_available = response.data.languages_available;
      _this31.getProducts();
  ...
  created: function created() {
    ...
    Fire.$on("pay_now", function () {
      setTimeout(function () {
        _this32.paymentLines = [{
          amount: parseFloat(_this32.GrandTotal.toFixed(2)),
          payment_method_id: 2
        }];
        _this32.globalPaymentNote = '';
        _this32.selectedAccount = null;
